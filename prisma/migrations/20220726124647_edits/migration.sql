/*
  ...
  - You are about to alter the column `price` on the `FoodEntry` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.

*/
-- AlterTable
ALTER TABLE "User" ADD COLUMN "maxCalories" INTEGER;
ALTER TABLE "User" ADD COLUMN "maxPrice" INTEGER;
